...
import org.annotationsmox.seffhelper.functionclassification.EJBFunctionClassificationStrategy;
...
public class EJBFunctionClassificationStrategyTest extends AnnotationsMoxAbstractTest<List<BitSet>> {
    ...
    protected List<BitSet> executeTest(final String testMethodName) {
        ...
        AnnotationsMoxTestUtil.executeEJBmoxPCMRepositoryModelCreator(testMethodName, analysisResult);
