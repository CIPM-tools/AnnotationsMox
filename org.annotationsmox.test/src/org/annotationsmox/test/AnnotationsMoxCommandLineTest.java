...
import org.annotationsmox.commandline.AnnotationsMoxCommandLine;
...
public class AnnotationsMoxCommandLineTest extends AnnotationsMoxAbstractTest<AnalysisResult> {
    ...
    protected AnalysisResult executeTest(final String testMethodName) {
        final String inputPath = AnnotationsMoxTestUtil.TEST_CODE_FOLDER_NAME + "/" + testMethodName;

        final AnnotationsMoxCommandLine ejbCommandLine = new AnnotationsMoxCommandLine(inputPath,
                AnnotationsMoxTestUtil.TEST_OUTPUT_FOLDER_NAME + "/" + testMethodName);
    ...
    protected void assertTestTwoComponentsWithProvidedAndRequiredInterface(final AnalysisResult analysisResult) {
        final Repository repository = analysisResult.getInternalArchitectureModel();
        final System system = analysisResult.getSystemModel();
        AnnotationsMoxAssertHelper.assertRepositoryWithTwoComponentsAndProvidedAndRequiredInterfaces(repository, OperationInterface.class);
	...
	protected void assertTestTwoComponentsWithProvidedEventInterfaceAndRequiredInterface(AnalysisResult analysisResult) {
    	...
    	AnnotationsMoxAssertHelper.assertEventGroups(repository,AnnotationsMoxPCMRepositoryModelCreatorTest.NUMBER_OF_EVENT_GROUPS);
