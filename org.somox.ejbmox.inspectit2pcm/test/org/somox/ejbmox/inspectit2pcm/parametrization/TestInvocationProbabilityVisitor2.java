    ...
    public static void main(String[] args) {
        ...
        for (int k = 0; k < 2000; k++) {
            ...
            for (int i = 0; i < 20; i++) {
                ...
                learner.integratePath(mutationPath);
            }
            ...
            for (Path expectedPath : mutations) {
                String expected = TestUtils.pathToString(expectedPath);

                if (!actualSequences.contains(expected)) {
                    System.out.println("------------------");
                    System.out.println(expected + " not found in " + actualPaths);
