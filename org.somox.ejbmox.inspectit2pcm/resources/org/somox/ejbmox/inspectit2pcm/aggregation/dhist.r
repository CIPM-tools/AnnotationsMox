################################
# Copied from https://github.com/PalladioSimulator/Palladio-AIMED/blob/develop/AIMED/resources/dhist.r
################################
...
doublePDF<-function(myvector, nbins=nclass.Sturges(myvector))
{
    # Create histogram
    myhist <- dhist(myvector, nbins=nbins)
